...
This plugin supports only Swedish at the moment.

== Installation ==
1. Upload the plugin to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Insert the `[predikan]` (including square brackets) into the page where you want the table to show up

== Frequently asked questions == 
= How do I inser the table? =
