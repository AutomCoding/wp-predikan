...
<div class="wrap">
	...
	<form method="post" action="">
		...
		<input type="text" name="predikan_title" value="<?php echo get_option( 'predikan_title', '' ); ?>"/><br /><br />

		<label for="predikan_author"><?php esc_html_e( 'Creator', 'predikan' ); ?></label><br />
		<input type="text" name="predikan_author" value="<?php echo get_option( 'predikan_author', '' ); ?>"/>
		...
		<textarea class="large-text" name="predikan_description"><?php echo get_option( 'predikan_description', '' ); ?></textarea>
		...
		<input type="text" name="predikan_owner_name" value="<?php echo get_option( 'predikan_owner_name', '' ); ?>"/><br />

		<label for="predikan_owner_email"><?php esc_html_e( 'Email address', 'predikan' ); ?></label><br />
		<input type="text" name="predikan_owner_email" value="<?php echo get_option( 'predikan_owner_email', '' ); ?>"/><br />
